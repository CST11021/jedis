...
public class BinaryClient extends Connection {
    ...
    public BinaryClient(final String host, final int port, final boolean ssl, final SSLSocketFactory sslSocketFactory, final SSLParameters sslParameters, final HostnameVerifier hostnameVerifier) {
    ...
    public void zrevrangeByLex(final byte[] key, final byte[] max, final byte[] min, final int offset, final int count) {
    ...
    public void linsert(final byte[] key, final ListPosition where, final byte[] pivot, final byte[] value) {
    ...
    public void aclGenPass() {
        sendCommand(ACL, Keyword.GENPASS.raw);
    }
    ...
    public void aclUsers() {
        sendCommand(ACL, Keyword.USERS.raw);
    }

    public void aclCat() {
        sendCommand(ACL, Keyword.CAT.raw);
    }
